...
public interface GameApi {
	 ...
	 *
	 * @param username
	 *            of the player who has created the game
	 ...
	 *            of the player who has created the game
	 * @param idGame
	 *            of the game the user wants to join
	 ...
	 *            played by the user
	 * @param username
	 *            user who played the card
	 * @return
	 */
	boolean playCard(int idGame, Card<CardValue, CardSuit> card, String username); // TODO mi sa che va ritornato lo
	...
	/**
	 * @param idGame
	 *            the specific game reset the leading suit in order to start a new
	 *            round
	 */
